...
import Filters from "../../components/main/advice/AdviceFilters";

import AskAdvice from "../../components/main/advice/AskAdvice";
...
import PostCardsView from "../../components/main/advice/AdvicePostCardView";
                ...
                <Flex width={"100%"} bg="mainBG" overflow="hidden">
                    <Box flex="1" maxHeight={"100vh"} p={6}>
                        ...
                        <Modal blockScrollOnMount={false} closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose}>
                            <ModalOverlay />
                            <AskAdvice addingCheck={addingCheck} setAddingCheck={setAddingCheck} onClose={onClose} />
                        </Modal>
                            ...
                            <VStack>
                                <GridItem width="100%" paddingTop={"1.5vh"}>
                                    <Box boxShadow={'0 0 10px rgba(0, 0, 0, 0.4)'} borderRadius={"md"} width="100%" overflow="hidden">
                                        <SpecializedFeedWindow maxh={"77vh"} title="Advice">
                                            <Box>
