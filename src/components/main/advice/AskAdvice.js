...
const AskAdvice = ( { addingCheck, setAddingCheck, onClose } ) => {
    ...
    const onSubmit = async () => {
        try {
            ...
            await setDoc(docRef, adviceData);
    ...
    return (
        <ModalContent maxW={{ base: "95%", lg: "80%" }}>
            ...
            <Box>
                ...
                <ModalHeader fontWeight={"bold"} fontSize={"2xl"} pb={'0px'} textAlign="center">Ask for Advice</ModalHeader>
